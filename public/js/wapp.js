    ...
    a.fn.extend({
        ...
        closeModal: function (b) {
            ...
            a(".modal-close").off(), a(document).off("keyup.leanModal"), a("#lean-overlay").velocity({opacity: 0}, {
                ...
                duration: b.out_duration, queue: !1, ease: "easeOutCubic", complete: function () {
            ...
            if (!a(this).hasClass("intialized")) {
                ...
                g.wrap(h), g.on("click", function () {
                    ...
                    if (a("body").append(l), l.velocity({opacity: 1}, {
                        ...
                        m.text(g.data("caption")), a("body").append(m), m.css({display: "block"}), m.velocity({opacity: 1}, {
                            duration: e,
                            queue: !1,
                            easing: "easeOutQuad"
                        })
